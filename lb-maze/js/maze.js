...
(function() {
  ...
  Block = (function() {
    ...
    Block.prototype.getNextBlock = function() {
      ...
      for (_i = 0, _len = directions.length; _i < _len; _i++) {
        ...
        x = pt[0];
        y = pt[1];
        if (x >= this.mmap.maxX || x < 0 || y >= this.mmap.maxY || y < 0) {
          continue;
        }
        if (this.mmap.mmap[x][y]) {
          continue;
        }
        this.walls[direction] = false;
  ...
  Solver = (function() {
    ...
    Solver.prototype.solve = function(mmap) {
      ...
      steps = (function() {
        ...
        _results = [];
        for (x = _i = 0, _ref = mmap.maxX; 0 <= _ref ? _i < _ref : _i > _ref; x = 0 <= _ref ? ++_i : --_i) {
          _results.push((function() {
            var _j, _ref1, _results1;
            _results1 = [];
            for (y = _j = 0, _ref1 = mmap.maxY; 0 <= _ref1 ? _j < _ref1 : _j > _ref1; y = 0 <= _ref1 ? ++_j : --_j) {
  ...
  Map = (function() {
    ...
    Map.prototype.genMap = function(maxX, maxY) {
      ...
      this.mmap = (function() {
        var _i, _ref, _results;
        _results = [];
        for (x = _i = 0, _ref = this.maxX; 0 <= _ref ? _i < _ref : _i > _ref; x = 0 <= _ref ? ++_i : --_i) {
          _results.push((function() {
            var _j, _ref1, _results1;
            _results1 = [];
            for (y = _j = 0, _ref1 = this.maxY; 0 <= _ref1 ? _j < _ref1 : _j > _ref1; y = 0 <= _ref1 ? ++_j : --_j) {
              _results1.push(false);
            }
            return _results1;
          }).call(this));
    ...
    Map.prototype.moveNext = function(x, y, direction) {
      if (this.mmap[x][y].walls[direction]) {
        return false;
      }
  ...
  DrawMap = (function() {
    ...
    DrawMap.prototype.drawMap = function() {
      ...
      for (y = _i = 0, _ref = this.mmap.maxY; 0 <= _ref ? _i < _ref : _i > _ref; y = 0 <= _ref ? ++_i : --_i) {
        for (x = _j = 0, _ref1 = this.mmap.maxX; 0 <= _ref1 ? _j < _ref1 : _j > _ref1; x = 0 <= _ref1 ? ++_j : --_j) {
  ...
  timer = setInterval(function() {
    if (!end) {
      return elTimer.text(fmtTime(new Date() - startTime));
    }
  }, 1000);
